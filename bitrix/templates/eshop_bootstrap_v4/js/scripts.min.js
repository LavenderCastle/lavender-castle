...
!(function (e, t) {
    ...
    var S = (function (e) {
            ...
            if (!i && (p(t), (t = t || f), g)) {
                if (11 !== w && (u = J.exec(e)))
                    if ((s = u[1])) {
                        ...
                        if (u[2]) return _.apply(o, t.getElementsByTagName(e)), o;
                        if ((s = u[3]) && n.getElementsByClassName && t.getElementsByClassName) return _.apply(o, t.getElementsByClassName(s)), o;
                    }
                if (n.qsa && !P[e + " "] && (!v || !v.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                    ...
                    try {
                        return _.apply(o, y.querySelectorAll(m)), o;
                    } catch (t) {
                        P(e, !0);
                    } finally {
        ...
        (ae.matchesSelector = function (e, t) {
            if ((p(e), n.matchesSelector && g && !P[t + " "] && (!m || !m.test(t)) && (!v || !v.test(t))))
                try {
                    var o = y.call(e, t);
        ...
        function Se(e, t, n, o, i, s) {
            return (
                ...
                ce(function (s, r, a, l) {
                    ...
                    } else (m = Te(m === r ? m.splice(h, m.length) : m)), i ? i(null, r, m, l) : _.apply(r, m);
                })
            );
        }
        function ke(e) {
            for (
                ...
                if ((n = o.relative[e[l].type])) p = [xe(we(p), n)];
                    ...
                    if ((n = o.filter[e[l].type].apply(null, e[l].matches))[x]) {
                        ...
                        return Se(1 < l && we(p), 1 < l && be(e.slice(0, l - 1).concat({ value: " " === e[l - 2].type ? "*" : "" })).replace(R, "$1"), n, l < i && ke(e.slice(l, i)), i < s && ke((e = e.slice(i))), i < s && be(e));
                    }
                    p.push(n);
                }
            return we(p);
        ...
        return (
            ...
            (r = ae.tokenize = function (e, t) {
                ...
                for (a = e, l = [], c = o.preFilter; a; ) {
                    for (r in ((n && !(i = W.exec(a))) || (i && (a = a.slice(i[0].length) || a), l.push((s = []))),
                    (n = !1),
                    (i = B.exec(a)) && ((n = i.shift()), s.push({ value: n, type: i[0].replace(R, " ") }), (a = a.slice(n.length))),
                    o.filter))
                    ...
                    (v = C(
                        ...
                        (d = function (e, t, n, r, d) {
                            var u,
                                ...
                                $ = S.length;
                            for (d && (c = t == f || t || d); y !== $ && null != (u = S[y]); y++) {
                                if (l && u) {
                            ...
                            if (((m += y), a && y !== m)) {
                                ...
                                if (e) {
                                    if (0 < m) for (; y--; ) b[y] || x[y] || (x[y] = j.call(r));
                                    x = Te(x);
                                }
                                _.apply(r, x), d && !e && 0 < x.length && 1 < m + s.length && ae.uniqueSort(r);
                            }
                            return d && ((T = k), (c = w)), b;
                        }),
                        a ? ce(d) : d)
                ...
                if (((n = n || []), 1 === f.length)) {
                    ...
                    for (s = V.needsContext.test(e) ? 0 : l.length; s-- && ((c = l[s]), !o.relative[(d = c.type)]); )
                        if ((u = o.find[d]) && (i = u(c.matches[0].replace(te, ne), (ee.test(l[0].type) && me(t.parentNode)) || t))) {
                            if ((l.splice(s, 1), !(e = i.length && be(l)))) return _.apply(n, i), n;
                            break;
                        }
                }
    ...
    ((w.fn.init = function (e, t, n) {
        ...
        if (((n = n || L), "string" == typeof e)) {
            ...
            if (o[1]) {
                if (((t = t instanceof w ? t[0] : t), w.merge(this, w.parseHTML(o[1], t && t.nodeType ? t.ownerDocument || t : v, !0)), A.test(o[1]) && w.isPlainObject(t))) for (o in t) h(this[o]) ? this[o](t[o]) : this.attr(o, t[o]);
                return this;
            }
        ...
        w.each(
            {
                ...
                contents: function (e) {
                    return null != e.contentDocument && o(e.contentDocument) ? e.contentDocument : (P(e, "template") && (e = e.content || e), w.merge([], e.childNodes));
                },
            },
            function (e, t) {
                w.fn[e] = function (n, o) {
                    var i = w.map(this, t, n);
                    return "Until" !== e.slice(-5) && (o = n), o && "string" == typeof o && (i = w.filter(o, i)), 1 < this.length && (_[e] || w.uniqueSort(i), D.test(e) && i.reverse()), this.pushStack(i);
                };
            }
        );
    var O = /[^\x20\t\r\n\f]+/g;
    ...
    (w.Callbacks = function (e) {
        ...
        w.extend({
                ...
                var n = [
                    ...
                    i = {
                        ...
                        then: function (t, o, i) {
                                        ...
                                        c = function () {
                                            ...
                                            if (!(t < s)) {
                                                ...
                                                (c = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                    h(c)
                                                        ? i
                                                            ? c.call(e, r(s, n, M, i), r(s, n, q, i))
                                                            : (s++, c.call(e, r(s, n, M, i), r(s, n, q, i), r(s, n, M, n.notifyWith)))
                                                        : (o !== M && ((a = void 0), (l = [e])), (i || n.resolveWith)(a, l));
                                            }
                                        },
                                        d = i
                                            ? c
                            ...
                            return w
                                .Deferred(function (e) {
                                    n[0][3].add(r(0, e, h(i) ? i : M, e.notifyWith)), n[1][3].add(r(0, e, h(t) ? t : M)), n[2][3].add(r(0, e, h(o) ? o : q));
                                })
                                .promise();
                        },
                        promise: function (e) {
            ...
            when: function (e) {
                ...
                if (t <= 1 && (I(e, r.done(a(n)).resolve, r.reject, !t), "pending" === r.state() || h(s[n] && s[n].then))) return r.then();
                for (; n--; ) I(s[n], a(n), r.reject);
                return r.promise();
            },
        });
    ...
    (w.fn.ready = function (e) {
        ...
        w.extend({
            ...
            readyWait: 1,
            ready: function (e) {
                (!0 === e ? --w.readyWait : w.isReady) || ((w.isReady = !0) !== e && 0 < --w.readyWait) || N.resolveWith(v, [w]);
            },
        }),
        (w.ready.then = N.then),
    ...
    var R = function (e, t, n, o, i, s, r) {
            var a = 0,
                l = e.length,
                c = null == n;
            if ("object" === b(n)) for (a in ((i = !0), n)) R(e, t, a, n[a], !0, s, r);
            else if (
                void 0 !== o &&
                ((i = !0),
                h(o) || (r = !0),
    ...
    function J(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType)
            if (((o = "data-" + t.replace(Q, "-$&").toLowerCase()), "string" == typeof (n = e.getAttribute(o)))) {
                try {
    ...
    w.extend({
        ...
        w.fn.extend({
            data: function (e, t) {
                var n,
                    ...
                    r = s && s.attributes;
                if (void 0 === e) {
                    if (this.length && ((i = K.get(s)), 1 === s.nodeType && !G.get(s, "hasDataAttrs"))) {
        ...
        w.extend({
            queue: function (e, t, n) {
                var o;
                if (e) return (t = (t || "fx") + "queue"), (o = G.get(e, t)), n && (!o || Array.isArray(n) ? (o = G.access(e, t, w.makeArray(n))) : o.push(n)), o || [];
            },
        ...
        w.fn.extend({
            ...
            promise: function (e, t) {
                ...
                for ("string" != typeof e && ((t = e), (e = void 0)), e = e || "fx"; r--; ) (n = G.get(s[r], e + "queueHooks")) && n.empty && (o++, n.empty.add(a));
    ...
    function ce(e, t) {
        for (var n, o, i, s, r, a, l, c = [], d = 0, u = e.length; d < u; d++)
            (o = e[d]).style &&
                ((n = o.style.display),
                t
                    ? ("none" === n && ((c[d] = G.get(o, "display") || null), c[d] || (o.style.display = "")),
                      "" === o.style.display &&
                          re(o) &&
                          (c[d] =
                              ((l = r = s = void 0),
                    ...
                    : "none" !== n && ((c[d] = "none"), G.set(o, "display", n)));
    ...
    function Ce(e, t, n, o, i, s) {
        var r, a;
        if ("object" == typeof t) {
            for (a in ("string" != typeof n && ((o = o || n), (n = void 0)), t)) Ce(e, a, n, o, t[a], s);
            return e;
        }
              ...
              w.event.add(e, t, {
                  ...
                  handler: function (e) {
                      ...
                      if (1 & e.isTrigger && this[t]) {
                          ...
                          else if (((r = i.call(arguments)), G.set(this, t, r), (o = n(this, t)), this[t](), r !== (s = G.get(this, t)) || o ? G.set(this, t, !1) : (s = {}), r !== s))
                              return e.stopImmediatePropagation(), e.preventDefault(), s.value;
                      } else r.length && (G.set(this, t, { value: w.event.trigger(w.extend(r[0], w.Event.prototype), r.slice(1), this) }), e.stopImmediatePropagation());
                  },
              }))
    ...
    (w.event = {
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return pe.test(t.type) && t.click && P(t, "input") && Pe(t, "click", Se), !1;
                },
                trigger: function (e) {
                    var t = this || e;
    ...
    function He(e, t) {
        var n, o, i, s, r, a;
        if (1 === t.nodeType) {
            if (G.hasData(e) && (a = G.get(e).events)) for (i in (G.remove(t, "handle events"), a)) for (n = 0, o = a[i].length; n < o; n++) w.event.add(t, i, a[i][n]);
            K.hasData(e) && ((s = K.access(e)), (r = w.extend({}, s)), K.set(t, r));
        }
    }
    function Oe(e, t, n, o) {
        t = s(t);
        ...
        if (p && ((r = (i = be(t, e[0].ownerDocument, !1, e, o)).firstChild), 1 === i.childNodes.length && (i = r), r || o)) {
            for (l = (a = w.map(ve(i, "script"), De)).length; u < p; u++) (c = i), u !== g && ((c = w.clone(c, !0, !0)), l && w.merge(a, ve(c, "script"))), n.call(e[u], c, u);
            if (l)
                for (d = a[a.length - 1].ownerDocument, w.map(a, _e), u = 0; u < l; u++)
                    (c = a[u]),
                        he.test(c.type || "") &&
    ...
    w.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n) for (s = s || ve(e), r = r || ve(d), o = 0, i = s.length; o < i; o++) He(s[o], r[o]);
                else He(e, d);
    ...
    function Fe(e, t, n) {
        ...
        return (
            (n = n || Ie(e)) &&
                ...
                !f.pixelBoxStyles() && qe.test(r) && Ne.test(t) && ((o = a.width), (i = a.minWidth), (s = a.maxWidth), (a.minWidth = a.maxWidth = a.width = r), (r = n.width), (a.width = o), (a.minWidth = i), (a.maxWidth = s))),
            void 0 !== r ? r + "" : r
        );
    }
    function Re(e, t) {
    ...
    function Je(e, t, n) {
        ...
        return (
            ((!f.boxSizingReliable() && i) || (!f.reliableTrDimensions() && P(e, "tr")) || "auto" === r || (!parseFloat(r) && "inline" === w.css(e, "display", !1, o))) &&
                e.getClientRects().length &&
                ((i = "border-box" === w.css(e, "boxSizing", !1, o)), (s = a in e) && (r = e[a])),
            (r = parseFloat(r) || 0) + Qe(e, t, n || (i ? "border" : "content"), s, o, r) + "px"
        );
    }
            ...
            w.cssHooks[t] = {
                ...
                set: function (e, n, o) {
                    var i,
                        ...
                        l = o ? Qe(e, t, o, a, s) : 0;
                    return (
                        a && r && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(s[t]) - Qe(e, t, "border", !1, s) - 0.5)),
                ...
                if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(f))
                    ...
                    f))
                        l ||
                            ...
                            g && ce([e], !0),
                            p.done(function () {
                                for (o in (g || ce([e]), G.remove(e, "fxshow"), f)) w.style(e, o, f[o]);
                            })),
                            (l = dt(g ? v[o] : 0, o, p)),
            ...
            if (
                ...
                for (s = 0; (r = m[s++]) && !t.isPropagationStopped(); )
                    (f = r),
                        ...
                        (u = (G.get(r, "events") || Object.create(null))[t.type] && G.get(r, "handle")) && u.apply(r, n),
    ...
    function Et(e, t, n, o) {
        ...
        if (Array.isArray(t))
            w.each(t, function (t, i) {
                n || $t.test(e) ? o(e, i) : Et(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, o);
            });
        ...
        w.fn.extend({
            ...
            serializeArray: function () {
                return this.map(function () {
                    ...
                    .filter(function () {
                        var e = this.type;
                        return this.name && !w(this).is(":disabled") && At.test(this.nodeName) && !Pt.test(e) && (this.checked || !pe.test(e));
                    })
                    .map(function (e, t) {
                        var n = w(this).val();
                        return null == n
    ...
    (zt.href = Tt.href),
        w.extend({
            ...
            ajax: function (t, n) {
                ...
                var o,
                    ...
                    k = {
                        ...
                        getResponseHeader: function (e) {
                            var t;
                            if (c) {
                                if (!r) for (r = {}; (t = _t.exec(s)); ) r[t[1].toLowerCase() + " "] = (r[t[1].toLowerCase() + " "] || []).concat(t[2]);
                                t = r[e.toLowerCase() + " "];
                            }
                ...
                if ((f.data && f.processData && "string" != typeof f.data && (f.data = w.param(f.data, f.traditional)), Ft(Mt, f, n, k), c)) return k;
                ...
                f.hasContent
                    ...
                    : ((p = f.url.slice(i.length)),
                      ...
                      !1 === f.cache && ((i = i.replace(Dt, "$1")), (p = (kt.test(i) ? "&" : "?") + "_=" + St.guid++ + p)),
                      (f.url = i + p)),
                ...
                k.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + It + "; q=0.01" : "") : f.accepts["*"]),
                f.headers))
                    k.setRequestHeader(u, f.headers[u]);
                if (f.beforeSend && (!1 === f.beforeSend.call(h, k, f) || c)) return k.abort();
                if (((S = "abort"), y.add(f.complete), k.done(f.success), k.fail(f.error), (o = Ft(qt, f, n, k)))) {
                            ...
                            return function () {
                                n &&
                                    ...
                                    "abort" === e
                                        ...
                                        : s(Wt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? { binary: a.response } : { text: a.responseText }, a.getAllResponseHeaders()));
                            };
                        }),
                            (a.onload = n()),
    ...
    w.ajaxSetup({
        ...
        (w.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  ...
                  (s = !n && []),
                  (i = A.exec(e)) ? [t.createElement(i[1])] : ((i = be([e], t, s)), s && s.length && w(s).remove(), w.merge([], i.childNodes)));
            var o, i, s;
        }),
        ...
        w.each(["top", "left"], function (e, t) {
            w.cssHooks[t] = Re(f.pixelPosition, function (e, n) {
                if (n) return (n = Fe(e, t)), qe.test(n) ? w(e).position()[t] + "px" : n;
            });
        }),
                                        ...
                                        if (!T.prop("readonly")) {
                                            ...
                                            (f = T.val()),
                                                8 === s || 46 === s || (o && 127 === s)
                                                    ...
                                                    : 13 === s
                                                    ? y.call(this, e)
                                                    : 27 === s && (T.val($), T.caret(0, w()), e.preventDefault());
                                        }
                                    })
    ...
    $(window).scroll(function () {
        $(this).scrollTop() > $(".header").height() - 59 ? $(".header").addClass("header--sticky") : $(".header").removeClass("header--sticky");
    }),
    $(".smi-carousel").slick({
        dots: !1,
        arrows: !1,
        ...
        responsive: [
            ...
            { breakpoint: 767, settings: { arrows: !1, slidesToShow: 2, slidesToScroll: 2 } },
        ],
    }),
    $(".contact-top__slider").slick({ dots: !1, arrows: !0, infinite: !0, speed: 300, slidesToShow: 2, responsive: [{ breakpoint: 767, settings: { arrows: !1, slidesToShow: 1 } }] }),
    $(".contact-top__slider2").slick({ dots: !1, arrows: !0, infinite: !0, speed: 300, slidesToShow: 1 }),
    $(document).ready(function () {
        if ($("#map1").length) {
            ymaps.ready(function () {
                var e = new ymaps.Map("map1", { center: [55.8485817, 37.6377706], zoom: 14, controls: ["zoomControl"] }),
                    t = new ymaps.Placemark(
                        [55.8485817, 37.6377706],
                        { hintContent: "Лавандовый Замок", balloonContent: "<b>Лавандовый Замок</b><br>Москва, м. Ботанический сад, Лазоревый проезд, 1<br />10.00-20.00, без выходных" },
                        { iconLayout: "default#image", iconImageHref: "/bitrix/templates/eshop_bootstrap_v4/img/icons/marker1.svg", iconImageSize: [100, 110], iconImageOffset: [-50, -50] }
                    );
                e.behaviors.disable("scrollZoom"), e.geoObjects.add(t);
            });
        }
    }),
    $(".contact-map__tabs a").click(function () {
        $(".contact-map__tabs a").removeClass("active"), $(this).addClass("active"), $(".contact-map__content").removeClass("active"), $(".contact-map__content").eq($(this).index()).addClass("active");
    }),
    $(".element__photos-for").slick({ infinite: !0, slidesToShow: 1, slidesToScroll: 1, arrows: !1, dots: !1, asNavFor: ".element__photos-nav" }),
    $(".element__photos-nav").slick({ infinite: !0, slidesToShow: 3, asNavFor: ".element__photos-for", dots: !1, arrows: !1, focusOnSelect: !0 }),
    $(".phoneinput").mask("+7 (999) 999-9999"),
    $("#soa-property-3").mask("+7 (999) 999-9999"),
    $(document).on("click", ".auth__link", function (e) {
        e.preventDefault(), $(".auth__panel").removeClass("active"), $($(this).attr("href")).addClass("active");
    }),
    $("#form-img").change(function () {
        var e = this.files[0],
            t = new FileReader();
        (t.onloadend = function () {
            $(".form__placeholder").css("background-image", 'url("' + t.result + '")');
        }),
            e && t.readAsDataURL(e);
    }),
    $(".form").submit(function (e) {
        e.preventDefault();
        var t = new FormData();
        t.append("name", $("#form-name").val()),
            t.append("phone", $("#form-phone").val()),
            t.append("message", $("#form-message").val()),
            t.append("file", $("#form-img")[0].files[0]),
            jQuery.ajax({
                url: "/ajax/form.php",
                data: t,
                cache: !1,
                ...
                type: "POST",
                success: function (e) {
                    $(".form__answer").html(e), ym(31407293, "reachGoal", "individual_bouquet"), gtag("event", "individual_bouquet", { event_category: "individual_bouquet", event_label: "Lavender" });
                },
            });
    }),
    $(".header__callback").click(function () {
        $("#form-subject").val("Заказ обратного звонка. Лавандовый Замок."), $("#form-item").val(""), $(".header__popup--form").fadeIn();
    }),
    $(".login-trigger").click(function () {
        $(".auth__panel").removeClass("active"), $("#auth").addClass("active"), $(".header__popup--auth").fadeIn();
    }),
    $(".header__popup-close").click(function () {
        $(".header__popup").fadeOut();
    }),
    $(".element__one-click").click(function () {
        $("#form-subject").val("Заказ в один клик. Лавандовый Замок."), $("#form-item").val($(this).data("link")), $(".header__popup--form").fadeIn();
    }),
    $(".element__zakaz").click(function () {
        $("#form-subject").val("Предзаказ. Лавандовый Замок."), $("#form-item").val($(this).data("link")), $(".header__popup--form").fadeIn();
    }),
    $("#auth form").submit(function (e) {
        ...
        $.ajax({
            ...
            data: t,
            success: function (e) {
                "ok" == e ? (window.location.href = "/personal/") : $("#auth .header__popup-answer").html(e);
            },
        });
    }),
    $("#register form").submit(function (e) {
        ...
        $.ajax({
            ...
            data: t,
            success: function (e) {
                "ok" == e ? (window.location.href = "/personal/") : $("#register .header__popup-answer").html(e);
            },
        });
    }),
    $("#forgot form").submit(function (e) {
        e.preventDefault(), $("#sms-phone").val($("#forgot-phone").val());
        var t = $(this).serialize();
        $.ajax({
            type: "POST",
            url: "/ajax/forgot.php",
            data: t,
            success: function (e) {
                "smscode" == e ? ($(".auth__panel").removeClass("active"), $("#sms").addClass("active")) : $("#forgot .header__popup-answer").html(e);
            },
        });
    }),
    $("#sms form").submit(function (e) {
        ...
        console,
            $.ajax({
                type: "POST",
                url: "/ajax/smscheck.php",
                data: t,
                success: function (e) {
                    "ok" == e ? (window.location.href = "/personal/userdata/") : $("#sms .header__popup-answer").html(e);
                },
            });
    }),
    $("#fast-form").submit(function (e) {
        if ((e.preventDefault(), "Заказ обратного звонка. Лавандовый Замок." == $("#form-subject").val())) var t = "order_a_call";
        if ("Заказ в один клик. Лавандовый Замок." == $("#form-subject").val()) t = "buy_in_1_click";
        var n = $("#fast-form").serialize();
        $.ajax({
            type: "POST",
            url: "/ajax/fast.php",
            data: n,
            success: function (e) {
                ...
                $("#fast-form .header__popup-answer").html(e),
                    ym(31407293, "reachGoal", t),
                    gtag("event", t, { event_category: t, event_label: "Lavender" }),
                    VK.Goal("lead"),
                    VK.Goal("conversion"),
                    "Заказ в один клик. Лавандовый Замок." == $("#form-subject").val() && (ym(31407293, "reachGoal", "order_total"), gtag("event", "order_total", { event_category: "order_total", event_label: "Lavender" }));
            },
        });
    }),
    $("#propusk-form").submit(function (e) {
        e.preventDefault();
        var t = $("#propusk-form").serialize();
        $.ajax({
            type: "POST",
            url: "/ajax/propusk.php",
            data: t,
            success: function (e) {
                VK.Goal("lead"), VK.Goal("conversion"), $(".contact-scheme__popup-answer").html(e);
            },
        });
    }),
    $(".contact-scheme__popup-close").click(function () {
        $(".contact-scheme__popup").fadeOut();
    }),
    $("#show-propusk-form").click(function () {
        $(".contact-scheme__popup").fadeIn();
    }),
    $("#contact-form").submit(function (e) {
        ...
        $.ajax({
            ...
            data: t,
            success: function (e) {
                VK.Goal("lead"), VK.Goal("conversion"), $(".contact-form__answer").html(e);
            },
        });
    }),
    $("#b2b-form").submit(function (e) {
        e.preventDefault();
        var t = $("#b2b-form").serialize();
        $.ajax({
            type: "POST",
            url: "/ajax/b2b.php",
            data: t,
            success: function (e) {
                $(".contact-form__answer").html(e),
                    VK.Goal("lead"),
                    VK.Goal("conversion"),
                    ym(31407293, "reachGoal", "franchise_form_success"),
                    gtag("event", "franchise_form_success", { event_category: "franchise_form_success", event_label: "Lavender" });
            },
        });
    }),
    $(".btn-anketa").click(function () {
        $("#vacancy-input").val($(this).data("vacancy")), $(".vacancies__popup").fadeIn();
    }),
    $(".vacancies__popup-close").click(function () {
        $(".vacancies__popup").fadeOut();
    }),
    $("#vacancies-form").submit(function (e) {
        e.preventDefault();
        var t = $("#vacancies-form").serialize();
        $.ajax({
            type: "POST",
            url: "/ajax/vacancies.php",
            data: t,
            success: function (e) {
                $(".vacancies__popup-answer").html(e);
            },
        });
    }),
    ...
    $(".offers__tabs a").click(function () {
        $(".offers__tabs a").removeClass("active"), $(".offers__tab-content").removeClass("active"), $(this).addClass("active"), $(".offers__tab-content").eq($(this).index()).addClass("active");
    });
var countSlides = $(".offers__tab-content").eq(0).find(".slick-dots li").length,
    countSlides2 = $(".offers__tab-content").eq(1).find(".slick-dots li").length,
    countSlides3 = $(".offers__tab-content").eq(2).find(".slick-dots li").length;
$(".offers__tab-content")
    .eq(0)
    .append('<div class="slick-counter"><span>1</span>/' + countSlides + "</div>"),
    $(".offers__tab-content")
        .eq(1)
        .append('<div class="slick-counter"><span>1</span>/' + countSlides2 + "</div>"),
    $(".offers__tab-content")
        .eq(2)
        .append('<div class="slick-counter"><span>1</span>/' + countSlides3 + "</div>"),
    $(".offers__tab-content")
        .eq(0)
        .find(".offers__carousel")
        .on("afterChange", function () {
            var e = $(".offers__tab-content").eq(0).find(".slick-dots li.slick-active").index() + 1;
            $(this).parent().find(".slick-counter span").text(e);
        }),
    $(".offers__tab-content")
        .eq(1)
        .find(".offers__carousel")
        .on("afterChange", function () {
            var e = $(".offers__tab-content").eq(1).find(".slick-dots li.slick-active").index() + 1;
            $(this).parent().find(".slick-counter span").text(e);
        }),
    $(".offers__tab-content")
        .eq(2)
        .find(".offers__carousel")
        .on("afterChange", function () {
            var e = $(".offers__tab-content").eq(2).find(".slick-dots li.slick-active").index() + 1;
            $(this).parent().find(".slick-counter span").text(e);
        });
countSlides = $(".testimonials__carousel .testimonials__item").length;
$(".testimonials__carousel").slick({
    ...
    responsive: [
        ...
        { breakpoint: 767, settings: { arrows: !1, slidesToShow: 1 } },
    ],
}),
    $(".testimonials__more").click(function () {
        var e = $(this).parent().parent().html();
        $(".testimonials__popup-content").html(e), $(".testimonials__popup").fadeIn();
    }),
    $(".testimonials__popup-close").click(function () {
        $(".testimonials__popup").fadeOut();
    }),
    $(".testimonials__carousel").append('<div class="slick-counter"><span>1</span>/' + countSlides + "</div>"),
    $(".testimonials__carousel").on("afterChange", function () {
        var e = $(".testimonials__carousel .testimonials__item.slick-current").data("slick-index") + 1;
        $(this).parent().find(".slick-counter span").text(e);
    });
