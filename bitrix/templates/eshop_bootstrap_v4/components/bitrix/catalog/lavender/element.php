...
/* Шапка с картинкой секции
?>
<div class="catalog-top">
            <div class="container">
                <div class="catalog-top__caption"><?=$currentSec?></div>
...
<div class="breadcrumbs" id="navigation">
	<div class="container">
		...
		$elementId = $APPLICATION->IncludeComponent('bitrix:catalog.element', 'lavender', $componentElementParams,
			$component
		);
		...
		if ($elementId > 0)
		{
			...
			if (!empty($recommendedData))
			{
				...
				{
					?>
							<? $APPLICATION->IncludeComponent('bitrix:catalog.products.viewed', 'lavender', array(
									'IBLOCK_MODE' => 'single',
									'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
									'IBLOCK_ID' => $arParams['IBLOCK_ID'],
									'ELEMENT_SORT_FIELD' => $arParams['ELEMENT_SORT_FIELD'],
