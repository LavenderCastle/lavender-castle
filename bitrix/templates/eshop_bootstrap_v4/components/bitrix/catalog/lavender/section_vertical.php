...
<div class="catalog-top">
            <div class="container">
                <h1 class="catalog-top__caption">
									<?
									echo (
						         isset($SEO["SECTION_PAGE_TITLE"]) && $SEO["SECTION_PAGE_TITLE"] != ""
						         ? $SEO["SECTION_PAGE_TITLE"]
						         : $currentSec
						      );
									?>
								</h1>
  ...
  <div class="container">
		...
		<div class="catalog__filter">
				...
				if ($isFilter): ?>
						...
						$APPLICATION->IncludeComponent(
					    "kombox:filter",
					    "lavender", //шаблон - .default (можно указать horizontal, bitronic-vertical или bitronic-horizontal)
					    array(
					        "IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
					        "IBLOCK_ID" => $arParams["IBLOCK_ID"],
        ...
        <div class="catalog__sort"><span>Сортировать по:</span>
					<a href="?sort_by=popular" rel="nofollow" <?if ($sortby=='sort') echo 'class="active"';?>>Популярности</a>
