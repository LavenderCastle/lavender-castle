...
?>
		...
		if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
		{
			$areaIds = array();
			?>
			<section class="section section--nopb offers">
				<div class="container" data-entity="<?=$containerName?>">
				<h2 class="section-caption">Вы недавно смотрели</h2>
			<?
			...
			foreach ($arResult['ITEM_ROWS'] as $rowData)
			{
				...
				?>
				<div class="offers__grid" data-entity="items-row">
					<?
                        ...
                        <a style="display: block;" href="#form" class="item__plus anchor"></a>
                        <h3 class="item__name">Оставьте заявку на ваш собственный букет</h3>
                        <div class="item__price">
                            <div class="item__newprice">?</div>
                        </div>
                        <div class="item__bottom"><a class="btn anchor" href="#form">Заказать</a></div>
              </div>
					</div>
					<?}
					?>
