	...
	BX.Sale.OrderAjaxComponent = {
			...
			button = BX.create('DIV', {
				...
				children: [
                    ...
                    BX.create('INPUT', {
                        props: {
                            type: 'submit',
                            className: 'btn intec-ui btn intec-ui-control-button intec-ui-mod-round-3 intec-ui-scheme-current intec-ui-size-2',
                    ...
                    children: [
                        BX.create('INPUT', {
                            props: {
                                ...
                                /* CUSTOM */
                                className: 'intec-ui btn intec-ui-control-button btn intec-ui-scheme-current',
                    ...
                    BX.create('DIV', {
                        ...
                        children: [
                            ...
                            BX.create('INPUT', {
                                props: {
                                    type: 'submit',
                                    className: 'bx-authform-buttons-register intec-ui btn intec-ui-control-button btn intec-ui-mod-round-3 intec-ui-scheme-current intec-ui-size-2',
			...
			if (this.result.AUTH.new_user_registration === 'Y')
			{
				nodes.push(BX.create('DIV', {
					...
					children: [
						...
						/* CUSTOM */
                        BX.create('A', {
                            props: {className: 'intec-ui btn intec-ui-control-button btn intec-ui-mod-round-3 intec-ui-scheme-current intec-ui-size-2'},
				...
				children: [
					...
					BX.create('DIV', {
						...
						children: [
							/* CUSTOM */
                            BX.create('A', {
                                props: {href: '', className: 'intec-ui btn intec-ui-control-button btn intec-ui-scheme-current'},
		...
		selectStore: function(event)
		{
			...
			if (storeItem && storeInput)
			{
				...
				button = BX.findChild(selectedPickUp, {className: 'btn intec-ui-control-button btn'}, true);

				if (button)
					button.text = this.params.MESS_SELECT_PICKUP;

				button = BX.findChild(storeItem, {className: 'btn intec-ui-control-button btn'}, true);
					...
					if (property.isMultiple())
					{
						propContainer.appendChild(
							BX.create('DIV', {
								...
								props: {className: 'intec-ui btn intec-ui-control-button btn intec-ui-scheme-current'},
		...
		alterProperty: function(settings, propContainer)
		{
			...
			{
				BX.addClass(add[i], 'intec-ui btn intec-ui-control-button btn intec-ui-scheme-current');
			...
			if (add.length)
			{
				...
				BX.bind(add, 'click', BX.delegate(function(e){
					...
					if (add.length && add[add.length - 2])
					{
						...
						BX.addClass(add[add.length - 2], 'intec-ui btn intec-ui-control-button btn intec-ui-scheme-current');
					}
					...
					BX.create('DIV', {
						...
						children: [
							BX.create('A', {
								props: {
									href: 'javascript:void(0)',
									className: 'intec-ui btn intec-ui-control-button btn intec-ui-mod-block intec-ui-mod-round-3 intec-ui-scheme-current intec-ui-size-2 btn-order-save'
								},
