	...
	?>
		<div class="catalog-section" data-entity="<?=$containerName?>">
			...
			if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
			{
				...
				?>
				<div class="catalog-edit__grid" style="margin-top: 30px; display: grid; grid-template-columns: 1fr; grid-gap: 20px;" data-entity="items-row">
				<?
