...
else
{
	...
	<div class="order-list">
		<?
			...
			{
				?>
				<a href="<?='/personal/orders/'//htmlspecialcharsbx($order["ORDER"]["URL_TO_DETAIL"])?>" class="order-list__item">
					...
					<?
						...
						?>
							<div class="order-list__icon <?=$class?> order-list__icon--payment" >
						...
						?>
							...
							<div class="order-list__icon <?=$class?> order-list__icon--delivery" >
								<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
