...
<p>Телефон: '.$phone.'</p>
<p>E-mail: '.$email.'</p>
<p>Сообщение: <br />'.$message.'</p>';

$altcontent = 'Имя - '.$name.', Телефон - '.$phone.', E-mail - '.$email.' ,Сообщение - '.$message;
...
if (($email!='')&&($message!='')){
  ...
  $mail->Subject = 'Форма обратной связи B2B. Лавандовый Замок.';
  ...
  if (!$mail->send()) {
    ...
    echo '<div class="header__popup-success">Спасибо! Мы получили ваше сообщение и ответим вам в самое ближайшее время.</div>';
  }
